...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "ALS | Controller")
	void SetController(AALSPlayerController* ALSControllerRef) { AsAlsController = ALSControllerRef; }

	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "ALS | Controller")
	AALSPlayerController* GetAlsController() const { return AsAlsController; }

	UFUNCTION(BlueprintGetter, Category = "ALS|Character States")
	EALSGroundedEntryState GetGroundedEntryState() const { return GroundedEntryState; }

	UFUNCTION(BlueprintSetter, Category = "ALS | Camera")
	void SetCamera(AALSPlayerCameraManager* CameraReference);

	UFUNCTION(BlueprintGetter, Category = "ALS | Camera")
	AALSPlayerCameraManager* GetCamera() const { return Camera; }
...
protected:
	...
	UPROPERTY(BlueprintReadOnly, VisibleAnywhere, Category = "ALS|Camera")
	TObjectPtr<AALSPlayerCameraManager> Camera;
	...
	AALSPlayerController* AsAlsController = nullptr;
