...
bool FInventoryStackHelper::TryStackItem(UInventoryManager& Manager, UItemInstance* Item)
{
...
bool FInventoryStackHelper::StackItems(UInventoryManager& Manager, UItemInstance* SourceItem, UItemInstance* TargetItem)
{
...
UItemInstance* FInventoryStackHelper::SplitStack(UInventoryManager& Manager, UItemInstance* Item, int32 Amount)
{
	if (!Item || Amount <= 0)
	{
		return nullptr;
