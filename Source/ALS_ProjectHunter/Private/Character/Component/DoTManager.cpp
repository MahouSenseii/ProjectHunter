	...
	float Duration, AActor* Instigator)
{
	if (!BleedEffectClass)
	{
		UE_LOG(LogDoTManager, Warning,
			TEXT("ApplyBleed: BleedEffectClass is not set on DoTManager"));
		return {};
	}
	...
	float Duration, AActor* Instigator)
{
	...
	{
		UE_LOG(LogDoTManager, Warning,
			TEXT("ApplyIgnite: IgniteEffectClass is not set on DoTManager"));
		return {};
	}
	...
	float Duration, AActor* Instigator)
{
	...
	{
		UE_LOG(LogDoTManager, Warning,
			TEXT("ApplyPoison: PoisonEffectClass is not set on DoTManager"));
		return {};
	}
	...
	float Duration, AActor* Instigator)
{
	...
	{
		UE_LOG(LogDoTManager, Warning,
			TEXT("ApplyChill: ChillEffectClass is not set on DoTManager"));
		return {};
	}
	...
	AActor* Instigator)
{
	...
	{
		UE_LOG(LogDoTManager, Warning,
			TEXT("ApplyFreeze: FreezeEffectClass is not set on DoTManager"));
		return {};
	}
	...
	float Duration, AActor* Instigator)
{
	...
	{
		UE_LOG(LogDoTManager, Warning,
			TEXT("ApplyShock: ShockEffectClass is not set on DoTManager"));
		return {};
	}
