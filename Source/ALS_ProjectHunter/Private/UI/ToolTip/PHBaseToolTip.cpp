...
void UPHBaseToolTip::NativeConstruct()
{
	...
	RarityColors.Add(EItemRarity::IR_GradeF, FLinearColor(0.025f, 0.46f, 0.982f, 0.9f));
    RarityColors.Add(EItemRarity::IR_GradeD, FLinearColor(0.16f, 0.86f, 1.0f, 0.9f));
    RarityColors.Add(EItemRarity::IR_GradeC, FLinearColor(1.0f, 0.946f, 0.447f, 0.9f));
    RarityColors.Add(EItemRarity::IR_GradeB, FLinearColor(0.41f, 0.032f, 0.5f, 0.9f));
    RarityColors.Add(EItemRarity::IR_GradeA, FLinearColor(0.11f, 0.49f, 1.0f, 0.9f));
    RarityColors.Add(EItemRarity::IR_GradeS, FLinearColor(1.0f, 0.0f, 0.0f, 0.9f));
    RarityColors.Add(EItemRarity::IR_Corrupted, FLinearColor::Black);
    RarityColors.Add(EItemRarity::IR_Unkown, FLinearColor(0.0251f, 0.462f, 0.982f, 0.6f));
    RarityColors.Add(EItemRarity::IR_None, FLinearColor(0.f, 0.f, 0.f, 0.9f));
	InitializeToolTip();
}
