...
public:
	...
	static void AddWeaponStatsSection(FItemTooltipData& TooltipData, const FBaseWeaponStats& Stats);
	static void AddArmorStatsSection(FItemTooltipData& TooltipData, const FBaseArmorStats& Stats);
	static void AddRequirementsSection(FItemTooltipData& TooltipData, const FItemStatRequirement& Requirements);
	static void AddDurabilitySection(FItemTooltipData& TooltipData, const FItemDurability& Durability);
