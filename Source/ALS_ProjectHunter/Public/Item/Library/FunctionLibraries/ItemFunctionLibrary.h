// Item/Library/FunctionLibraries/ItemFunctionLibrary.h
#pragma once
...
UCLASS()
class ALS_PROJECTHUNTER_API UItemFunctionLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	/**
	 * Calculate final damage with flat, increased, and more modifiers.
	 * Formula: Base + Flat, then Increased, then More.
