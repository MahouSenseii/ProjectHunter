...
enum class EHunterAttribute : uint8
{
	...
	PhysicalToFire          UMETA(DisplayName = "Physical to Fire %"),
	PhysicalToIce           UMETA(DisplayName = "Physical to Ice %"),
	PhysicalToLightning     UMETA(DisplayName = "Physical to Lightning %"),
	PhysicalToLight         UMETA(DisplayName = "Physical to Light %"),
	PhysicalToCorruption    UMETA(DisplayName = "Physical to Corruption %"),

	//  Damage Conversion  From Fire 
	FireToPhysical          UMETA(DisplayName = "Fire to Physical %"),
	FireToIce               UMETA(DisplayName = "Fire to Ice %"),
	FireToLightning         UMETA(DisplayName = "Fire to Lightning %"),
	FireToLight             UMETA(DisplayName = "Fire to Light %"),
	FireToCorruption        UMETA(DisplayName = "Fire to Corruption %"),

	//  Damage Conversion  From Ice 
	IceToPhysical           UMETA(DisplayName = "Ice to Physical %"),
	IceToFire               UMETA(DisplayName = "Ice to Fire %"),
	IceToLightning          UMETA(DisplayName = "Ice to Lightning %"),
	IceToLight              UMETA(DisplayName = "Ice to Light %"),
	IceToCorruption         UMETA(DisplayName = "Ice to Corruption %"),

	//  Damage Conversion  From Lightning 
	LightningToPhysical     UMETA(DisplayName = "Lightning to Physical %"),
	LightningToFire         UMETA(DisplayName = "Lightning to Fire %"),
	LightningToIce          UMETA(DisplayName = "Lightning to Ice %"),
	LightningToLight        UMETA(DisplayName = "Lightning to Light %"),
	LightningToCorruption   UMETA(DisplayName = "Lightning to Corruption %"),

	//  Damage Conversion  From Light 
	LightToPhysical         UMETA(DisplayName = "Light to Physical %"),
	LightToFire             UMETA(DisplayName = "Light to Fire %"),
	LightToIce              UMETA(DisplayName = "Light to Ice %"),
	LightToLightning        UMETA(DisplayName = "Light to Lightning %"),
	LightToCorruption       UMETA(DisplayName = "Light to Corruption %"),

	//  Damage Conversion  From Corruption 
	CorruptionToPhysical    UMETA(DisplayName = "Corruption to Physical %"),
	CorruptionToFire        UMETA(DisplayName = "Corruption to Fire %"),
	CorruptionToIce         UMETA(DisplayName = "Corruption to Ice %"),
	CorruptionToLightning   UMETA(DisplayName = "Corruption to Lightning %"),
	CorruptionToLight       UMETA(DisplayName = "Corruption to Light %"),
