...
struct ALS_PROJECTHUNTER_API FMonsterStatVariation
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct ALS_PROJECTHUNTER_API FMobTypeEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct ALS_PROJECTHUNTER_API FSpawnAttemptDebug
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct ALS_PROJECTHUNTER_API FMobSpecialSpawnRule
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct ALS_PROJECTHUNTER_API FPlayerLocationSnapshot
{
	GENERATED_BODY()
